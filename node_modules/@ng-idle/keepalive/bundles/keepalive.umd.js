...
var Keepalive = /** @class */ (function (_super) {
    ...
    Keepalive = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http.HttpClient, _angular_core.NgZone])
    ], Keepalive);
    return Keepalive;
...
var NgIdleKeepaliveModule = /** @class */ (function () {
    ...
    NgIdleKeepaliveModule = NgIdleKeepaliveModule_1 = __decorate$1([
        _angular_core.NgModule({ imports: [_ngIdle_core.NgIdleModule.forRoot()] })
