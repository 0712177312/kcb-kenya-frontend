(function (global, factory) {
    ...
    (factory((global.ngidle = global.ngidle || {}, global.ngidle.core = global.ngidle.core || {}),global.rxjs,global.rxjs_operators,global.ng.core));
...
var EventTargetInterruptSource = /** @class */ (function (_super) {
    ...
    function EventTargetInterruptSource(target, events, options) {
        ...
        var fromEvents = events.split(' ').map(function (eventName) { return rxjs.fromEvent(target, eventName, opts); });
        _this.eventSrc = rxjs.merge.apply(void 0, fromEvents);
        _this.eventSrc = _this.eventSrc.pipe(rxjs_operators.filter(function (innerArgs) { return !_this.filterEvent(innerArgs); }));
        if (_this.throttleDelay > 0) {
            _this.eventSrc = _this.eventSrc.pipe(rxjs_operators.throttleTime(_this.throttleDelay));
        }
...
var LocalStorageExpiry = /** @class */ (function (_super) {
    ...
    LocalStorageExpiry = __decorate$1([
        _angular_core.Injectable(),
        __metadata$1("design:paramtypes", [LocalStorage])
    ], LocalStorageExpiry);
...
var Idle = /** @class */ (function () {
    ...
    Idle = __decorate([
        ...
        __metadata("design:paramtypes", [IdleExpiry, _angular_core.NgZone, KeepaliveSvc])
    ], Idle);
    return Idle;
}());
...
var NgIdleModule = /** @class */ (function () {
    ...
    var NgIdleModule_1;
    NgIdleModule = NgIdleModule_1 = __decorate$3([
